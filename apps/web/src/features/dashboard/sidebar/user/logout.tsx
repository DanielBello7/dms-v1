    ...
    <AlertDialog>
      ...
      <AlertDialogContent className="p-0 w-[350px]!">
        ...
        <AlertDialogFooter className="p-0 border-t gap-0">
          ...
          <Button
            className="w-1/2 cursor-pointer border-none rounded-none rounded-r-md bg-white dark:bg-background text-destructive hover:bg-destructive/10 hover:text-destructive"
            variant="ghost"
