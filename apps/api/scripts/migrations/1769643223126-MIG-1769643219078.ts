...
export class MIG17696432190781769643223126 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "conversation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "ref_id" uuid NOT NULL, "index" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "ongoing_participants" character varying array NOT NULL, "members" character varying array NOT NULL, "created_by" uuid NOT NULL, "last_message_id" uuid, CONSTRAINT "UQ_c7d8aa1971684c87de7cfd5c754" UNIQUE ("ref_id"), CONSTRAINT "UQ_6459af38f36d522495f636ae454" UNIQUE ("index"), CONSTRAINT "PK_864528ec4274360a40f66c29845" PRIMARY KEY ("id"))`);
