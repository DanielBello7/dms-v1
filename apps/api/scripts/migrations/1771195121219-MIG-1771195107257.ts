...
export class MIG17711951072571771195121219 implements MigrationInterface {
    name = 'MIG17711951072571771195121219'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "conversation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "ref_id" uuid NOT NULL, "index" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "ongoing_participants" character varying array NOT NULL, "members" character varying array NOT NULL, "created_by" uuid NOT NULL, "last_message_id" uuid, "name" character varying, CONSTRAINT "UQ_c7d8aa1971684c87de7cfd5c754" UNIQUE ("ref_id"), CONSTRAINT "UQ_6459af38f36d522495f636ae454" UNIQUE ("index"), CONSTRAINT "REL_ba9e5fd8456128908d86c01c5b" UNIQUE ("last_message_id"), CONSTRAINT "PK_864528ec4274360a40f66c29845" PRIMARY KEY ("id"))`);
